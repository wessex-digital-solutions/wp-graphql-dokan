...
namespace WPGraphQL\Dokan\Connection;
...
class Vendors {
    ...
    /**
     * Registers the various connections from other Types to Vendor
     */
        ...
        return array_merge(
            array(
                ...
                'resolve'        => function ( $source, array $args, AppContext $context, ResolveInfo $info ) {
                    return Factory::resolve_vendor_connection( $source, $args, $context, $info );
                },
            ),
            $args
        );
